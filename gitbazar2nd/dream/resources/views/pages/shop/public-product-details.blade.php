...
@section('content')
 <div class="pld">
      ...
      @endif
        ...
        <h5>Product Price:{{$product->price_bdt}} tk</h5>
                     
                        
                           
       <form>
         <label>Quantity:</label>
          <input class="form-group" type="number" value="1" name="quantity"><span>Piece({{$product->quantity}} Pieces available)</span> 
          
          <div>
          <button class="btn btn-info" type="submit">Add To WishList</button>
          @if($product->quantity)
        ...
        <div class="panel-heading">
          <div class="container-fluid">
            <div class="row">
              ...
              <div class="col-sm-4"style="float: left; ">{{$product->price_bdt}} ৳</div>
              <div class="col-sm-2"style="float: left; "><a href="/shop/{{$shop->slug}}/product/{{$product->slug}}" class=""><span class="glyphicon badge">More</span></a></div>
...
{{$products->links()}}
                  ...
                  <div class="col-lg-3 col-sm-6 hero-feature text-center">
                     <!-- Thumbnail Images -->
                     <div class="thumbnail">
                        <a href="www.facebook.com" class="link-p"> <img src="{{asset('images/products/t1.jpg')}}" alt=""> </a>

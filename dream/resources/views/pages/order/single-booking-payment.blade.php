        ...
        <div class="col-xs-12 col-md-4">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form role='form' action="/shop/product/booking/complete" method="GET" enctype="multipart/form-data"> 
                         <input type="hidden" class="form-control"  name="shop_id" value="{{$shop->id}}" required >
                         @foreach($total as $total)
                         <input type="hidden" class="form-control"  name="sum" value="{{$total->total}}" required >
                         @endforeach

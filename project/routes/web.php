...
Route::get('/hotels','MarketController@hotels')->name('hotels');
...
//-----------------------Git Bazar Product Route------------------
Route::get('/gitbazar/products','Product\PagesController@index');
Route::get('/gitbazar/products/{category}','Product\PagesController@category');
Route::get('/gitbazar/products/{category}/type/{type}','Product\PagesController@type');
//-----------------------End Git Bazar Product Route------------------
//-------------------auth user route end---------------
//------------------------------Resorce Route Start---------------------------
 Route::resources([
...
//-------------------------------Store Route Start------------------------------
 ...
 Route::post('userrole/store','StoreController@userrole_store')->name('userrole.store');
  Route::post('myshop/store','StoreController1@shop_store')->name('myshop.store');

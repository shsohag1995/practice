        ...
        <div class="row">
          ...
          <div class="col-md-10">
            <!-- Website Overview -->
                ...
                <div class="col-md-3">
          <a href="shop.php"><h4> Hasan  garments NS road kushtia</h4></a>
      <div class="panel panel-primary">
        <div class="panel-heading">
          <div class="container-fluid">
            <div class="row">
              <div  class="col-sm-6"style="float: left; ">PRODUCT </div>
              <div class="col-sm-4"style="float: left; ">200000/-</div>
        ...
        <div class="panel-footer">
          ...
          <span class="glyphicon glyphicon-thumbs-up badge">100</span></a></div>

                  ...
                  <div class="one_shop_slider">
                      <div class="row">
                       ...
                       @if($shop->type=='Private'||$shop->agent=='agent')
                          <div class="col-md-6">
                              <div class="card shadow  single-shop-area">
                                  <div class="card-header d-flex justify-content-between p-1">
                                     ...
                                     {{$shop->star}}
                                      @endif</span></h6>
                                      <a href="/shop/{{$shop->slug}}"><h6 class="btn btn-sm btn-outline-info mb-0 p-2 text-uppercase text-bold border-0">{{$shop->name}}</h6></a>
                                  </div>
                                  <!-- /.card-header -->
                                  <div class="">
                              ...
                              <div class="card shadow  single-shop-area">
                                  <div class="card-header d-flex justify-content-between p-1">
                                     ...
                                     @endif
                                      ...
                                      <a class="border-0" href="/shop/{{$shop->slug}}"><h6 class="btn btn-sm btn-outline-info mb-0 p-2 text-uppercase text-bold border-0">{{$shop->name}}</h6></a>
                                  </div>
                                  <!-- /.card-header -->
                                  <div class="">
                                      <div id="{{$shop->slug}}" class="carousel slide carousel-fade" data-ride="carousel">

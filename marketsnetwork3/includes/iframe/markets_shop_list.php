...
<body>
<h3 style="text-align: center;">Wellcome to market name</h3>
...
<div class="container">
   ...
   <div class="col-md-6 col-sm-9" style="max-height: 250px; margin-top: 0px;">
    ...
    <div class="card hovercard grad1">
        <div class="card-background ">
          <div class="row">
            ...
            <img class="card-bkimg" alt="" src="../../image/shop5.jpg" style="width: 100%;height:200px;" >
            <!-- http://lorempixel.com/850/280/people/9/ -->
        </div>

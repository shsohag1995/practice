                    ...
                    <form class="form-group" action="/shop/private/product/image/view/update" method="POST" enctype="multipart/form-data">
                     ...
                     <div class="single-product-image-inner">
                      ...
                      @if($ok==1)
                        ...
                        <div  class="col-sm-6">
                           <form class="form-group" action="/shop/private/product/clothes/size/store" method="POST" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <input class="form-group" type="text" name="size">
                             <button class="btn btn-success" type="submit" class="btn btn-default" name="create" value="create">Add</button>
                          </form>
                        </div>
                        @endif
                     </div>
          ...
          <input type="hidden" name="shop_id" value="{{$shop->id}}">
           <input type="hidden" name="sp_counter_number" value="{{$product->sp_counter_number}}">
                         ...
                         <div class="form-group">
                           ...
                           @if($ok==1)
                           @foreach($sizes as $size)
                           <a  href="/shopmanage/{{$shop->id}}/product/{{$product->sp_counter_number}}/clothes/{{$size->created_at}}/size/destroy">{{$size->size}}
                           <span class="glyphicon glyphicon glyphicon-trash"></span>
                           </a>
                           @endforeach
                           @endif
                     ...
                     <div class="p-details-tab-content section-padding-2">
                        ...
                        <div class="tab-content review">
                           ...
                           <div role="tabpanel" class="tab-pane active" id="more-info">
                             ...
                             will return the value of the column directly:
          ...
          <div class="container-fluid">
            <div class="row">
              ...
              <button class="btn btn-success dropdown-toggle"type="button" data-toggle="dropdown" style="float: right; padding: 3px;">
               ...
               @endif
              @elseif(Auth::user()->id==$product->user_id || $ok==1)
                <button class="btn btn-success dropdown-toggle"type="button" data-toggle="dropdown" style="float: right; padding: 3px;">
                       <span class="caret"></span></button>
                        <ul id="shop_handelar" class="dropdown-menu">
                              <li><a href="#">Edit</a></li>

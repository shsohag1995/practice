...
class CreatePtrshopsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ptrshops', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->integer('ptrsp_counter')->default(0);

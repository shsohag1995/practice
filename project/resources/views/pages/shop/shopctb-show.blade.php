...
<div class="col-md-2">
  <div class="row">
  @include('partials.shop.shopctb-side-nav')
     </div>
     <div class="row">
                       ...
                       <span class="caret"></span></button>
                        <ul id="shop_handelar" class="dropdown-menu">
                              <li><a class="btn btn-info btn-sm " href="/shop/{{$shop->id}}/product/{{$product->sp_counter_number}}/edit">Edit</a></li>
                                 <li><a class="btn btn-warning btn-sm " class="btn btn-danger btn-sm " href="/shop/{{$shop->id}}/product/{{$product->sp_counter_number}}/hide">Hide</a></li>
                                  <li><a onclick="del({{$product->sp_counter_number}})"  href="#" class="btn btn-danger btn-sm ">Delete</a></li>
                       ...
                       <span class="caret"></span></button>
                        <ul id="shop_handelar" class="dropdown-menu">
                              <li><a href="/shop/{{$shop->id}}/product/{{$product->sp_counter_number}}/edit">Edit</a></li>
                                 <li><a href="/shop/{{$shop->id}}/product/{{$product->sp_counter_number}}/hide">Hide</a></li>

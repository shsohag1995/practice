     ...
     <div class="shopping-details table-responsive">
      <table id="cart" class="table table-hover table-condensed">
        ...
        <tr>
          ...
          <td><a href="/shop/{{$wishlist->shop_slug}}/product/{{$wishlist->sp_counter_number}}/name/{{$wishlist->product_slug}}">{{$wishlist->product_name}}</a></td>
          ...
          <td>{{$wishlist->price * $wishlist->quantity}}</td>
           <td  class="actions">
              ...
              @if($wishlist->action=='pending'||$wishlist->action=='cancled')
                <a href="/shop/{{$wishlist->shop_id}}/product/{{$wishlist->sp_counter_number}}/order/{{$wishlist->order_id}}/packed" class="btn btn-primary btn-sm ">Booking</a> 
                @elseif($wishlist->action=='packed')
                <a  class="btn btn-success btn-sm ">Booked</a> 

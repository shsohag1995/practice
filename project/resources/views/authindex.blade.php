...
<div class="wrapper">
  ...
  <div class="tab-content">
    <div id="user-info" class="container tab-pane active"><br>
          ...
          <div class="card-body box-profile">
                <div class="text-center">
                 ...
                 <p  class="text-center" ><a class="text-muted text-center" class="nav-link" href=""> MD SHARIFUL HASAN SOHAG</a></p>

                <p>Status: <a href="" class="text-muted text-center " class="nav-link" >Unverified</a></p>
              ...
              <ul class="list-group list-group-unbordered mb-3">
                    <li class="list-group-item">
                        ...
                        <ul class="list-group  mb-3 mt-2">
                            <li class="list-group-item">
                                <a href="" class="text-secondary">USD :</a> <a class="float-right">543</a>
                            </li>
                            <li class="list-group-item">
                                <a href="" class="text-secondary">BDT :</a> <a class="float-right">543</a>
                            </li>
                            <li class="list-group-item">
                                <a href="" class="text-secondary">CGC :</a><a class="float-right">543</a>
                            </li>
                        </ul>
                    </li>
                    <li class="list-group-item">
                    ...
                    <li class="list-group-item">
                        ...
                        <p><a class="text-muted  nav-link"  href=""><i class="fa fa-power-off"></i> <b> Logout</b></a></p>
                    </li>
    ...
    <div id="favorite-shops" class="container tab-pane fade"><br>
      <h3>Menu 1</h3>
      <p>this the feverate shop list.</p>
    </div>
    <div id="my-shop" class="container tab-pane fade"><br>
      <h3>Menu 2</h3>
      <p>this is ths list </p>
    </div>
  </div>
</div>
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Starting from 2017-2019 <a href="https://gitbazar.com">Gitbazar</a>.</strong> 
    </footer>
</div>
<!-- ./wrapper -->

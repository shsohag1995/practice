...
<section id="dashboard">
			<div class="container">
				<div class="row">
					...
					<div class="col-md-10">
						  <div class="row">
                                <form action="/shop/order/payment" method="GET" enctype="multipart/form-data">
                                  {{ csrf_field() }}
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="5" placeholder="Enter Shiping Address" name="shiping_address" value="" >{{$orderaddress->shiping_address}}</textarea>
                                            </div>
                                        </div><!-- end columns -->
                                      ...
                                      <!-- <label class="radio-inline navbar-brand" >
                                       ...
                                       <label class="radio-inline navbar-brand" >
                                        ...
                                        <label class="radio-inline navbar-brand" >
                                        <input  required type="radio" name="payment" value="rocket"><img src="{{asset('/images/payment/rocket.png')}}" alt=""style="width: 60px;height: 40px;float: left; ">
                                           </label>

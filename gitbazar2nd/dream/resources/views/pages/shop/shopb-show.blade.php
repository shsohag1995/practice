...
<div class="col-md-2">
  <div class="row">
  @include('partials.shop.shopb-side-nav')
     </div>
     <div class="row">
              ...
              <button class="btn btn-success dropdown-toggle"type="button" data-toggle="dropdown" style="float: right; padding: 3px;">
                       <span class="caret"></span></button>
                        <ul id="shop_handelar" class="dropdown-menu">
                              <li class="btn btn-info btn-sm "><a  href="/shop/{{$shop->id}}/product/{{$product->sp_counter_number}}/edit">Edit</a></li>
                                 <li class="btn btn-warning btn-sm "><a class="btn btn-worning btn-sm " href="/shop/{{$shop->id}}/product/{{$product->sp_counter_number}}/hide" >Hide</a></li>
                                     <li class="btn btn-danger btn-sm "><a href="/shopmanage/{{$shop->id}}/product/{{$product->sp_counter_number}}/private/destroy" >Delete</a></li>
                                 </ul>
               @endif

               ...
               <div class="row">
                  ...
                  <div class="col-md-offset-1 col-md-5 col-sm-6">
                     <div class="single-product-details">
                        ...
                        <div >
      <h3>Room Number:{{$product->title}}</h3>
       @if($product->quantity)
      <h4>In stock</h4>
      @else
      <h4>Is not  stock</h4>
      @endif
        <h3> Room Category:{{$product->category}}</h3>
        @if($product->type)
        ...
        <h5>Product Price:{{$product->price_bdt}}</h5>
          ...
          <div>
         <a href="/shop/{{$shop->id}}/product/{{$product->sp_counter_number}}/booking" class="btn btn-info">Room booking view</a>
          <a href="/shop/{{$shop->id}}/product/{{$product->sp_counter_number}}/booking" class="btn btn-success">Booking</a>
